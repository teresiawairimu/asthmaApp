...
class SymptomTrends:
  ...
  async def create_frequency_trend(self, data: DateRangeRequest, token: dict):
    """"""
  ...
  async def create_severity_trend(self, data: DateRangeRequest, token: dict):
    """"""
  ...
  async def create_correlation_trend(self, data: DateRangeRequest, token: dict):
    """"""
